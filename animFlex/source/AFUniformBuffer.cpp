...
void AFUniformBuffer::UploadUBOData(glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::mat4 modelMatrix)
{
	glBindBuffer(GL_UNIFORM_BUFFER, m_uboBuffer);
	...
	glBindBufferRange(GL_UNIFORM_BUFFER, 0, m_uboBuffer, 0, 3 * sizeof(glm::mat4));
	glBindBuffer(GL_UNIFORM_BUFFER, 0);
}
