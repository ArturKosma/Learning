...
public:
	...
	inline static FAFGraphNodeParamRegistrar<AFGraphNode_OutputCond, bool> _registrar_OutputCond = FAFGraphNodeParamRegistrar<AFGraphNode_OutputCond, bool>("OutputCond", "bool", &AFGraphNode_OutputCond::OutputCond, "Input");
